...
public class DirectoryRcr {
    ...
    // Run socket server on specified port and start read thread to receive file.
    ...
    // Start thread to read inStream and process the received bytes to file using processBytes method.
    ...
    private void processBytes(byte[] buff) throws InterruptedException {
        if (state == fileReceiveState || state == fileContentWaitState) {
            ...
            // TODO: 3/18/17 Correct file size calcution..
             count++;
    ...
    // Parse byte array to string(parsedMessage) (UTF-8) and set response message according to parsedMessage.
    ...
    // TODO: 3/18/17 Remove this method
